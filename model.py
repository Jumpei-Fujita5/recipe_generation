...
class RecipeBART(nn.Module):
    def __init__(self):
        ...
        configuration = BartConfig(d_model=300, decoder_ffn_dim=600, decoder_attention_heads=4, encoder_attention_heads=4, encoder_ffn_dim=600, decoder_layers=2, encoder_layers=1)
        self.tokenizer = BartTokenizer.from_pretrained("facebook/bart-base")
        self.bart = model = BartModel(configuration)
        self.dropout = nn.Dropout(0.1)
        self.projection_layer = nn.Linear(300, tokenizer.vocab_size)
